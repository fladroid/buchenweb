...
const BB_VERSION = 's81.7';
const BB_VERSION_DATE = '15 Jun 2026';
...
const NAV_I18N = {
  ...
  hr: { home:"Početna", about:"O projektu", stats:"X-Ray Statistike", books:"Knjižnica",
      ...
      <a href="https://ollama.com" target="_blank">Ollama</a> za lokalnu i cloud LLM inferenciju.`,
        ...
        art_q_abbott:"Gdje živi značenje?", art_q_borges:"Što ga odvaja od šuma?", art_q_wittgenstein:"Kako ga mjerimo?", art_q_kandinsky:"Kojim osjetom ga promatramo?",
  ...
  sr: { home:"Почетна", about:"О пројекту", stats:"X-Ray Статистике", books:"Библиотека",
      ...
      <a href="https://ollama.com" target="_blank">Ollama</a> за локалну и cloud LLM inferenciju.`,
        ...
        art_subtitle:"Исти подаци, други осјет — сонификација и генеративне визуелизације Buchenberg корпуса.",
        art_h_synesthesia:"Синестезија",
        art_synesthesia_intro:"Страница <a href='geometry.html' style='color:var(--accent)'>Геометрија</a> представила је три фигуре које су описале простор уградње прије него што се могао израчунати. Ова страница додаје четврту — и поставља питање које прве три никад нису поставиле: <em>којим осјетом бисмо га требали посматрати?</em>",
        ...
        art_q_abbott:"Гдје живи значење?", art_q_borges:"Шта га одваја од шума?", art_q_wittgenstein:"Како га мјеримо?", art_q_kandinsky:"Којим осјетом га посматрамо?",
        art_card_kandinsky_h:"О духовном у умјетности",
        art_card_kandinsky_p1:"2. јануара 1911. Василиј Кандински присуствовао је Шенберговом концерту у Münchenu. Оно што је чуо потакнуло га према апстракцији: за неколико недјеља насликао је <em>Импресију III (Концерт)</em>, а до краја године објавио је <em>О духовном у умјетности</em>.",
        art_card_kandinsky_p2:"његова средишња тврдња: боја, облик и звук нису ствари које се међусобно илуструју. Оне су <strong>различите пројекције истог унутарњег садржаја</strong>. Жута није <em>попут</em> трубе — обје су површине једне темељне вибрације, достигнуте различитим органима.",
        art_card_kandinsky_p3:"Кандински није имао математику за ову интуицију. Могао ју је само насликати. Тврдња да садржај постоји <em>прије</em> осјетила које га перципира морала је чекати стољеће на неочекивани доказ.",
        art_card_scriabin_h:"Прометеј: Поема ватре",
        art_card_scriabin_p1:"Александар Скрјабин ишао је даље од теорије — промијенио је партитуру. <em>Прометеј</em> укључује дионицу за <em>clavier à lumières</em>, тастатуру која свира свјетло: свака типка пуни дворану бојом.",
        art_card_scriabin_p2:"Свјетлосна дионица није украс. Уписана је у партитуру попут гудача или лимена — што знаčи да је дјело <strong>непотпуно кад се изводи само у једном каналу</strong>. Слушати <em>Прометеја</em> без гледања значи, по властитој дефиницији складатеља, слушати половину композиције.",
        art_card_scriabin_p3:"Скрјабинова премиса је оперативна, не мистична: ако је садржај један, једно осјетило га недовољно узоркује. Додај канал — врати више оригинала.",
        art_card_buchenberg_h:"Уградња је већ синестезија",
        art_card_buchenberg_p1:"Када multilingual-e5-large чита реченицу, пројицира је у тачку у 1024-димензионалном простору. Та тачка није текст. Није слика и није звук. Она је <strong>чист садржај без придруженог осјета</strong> — математичка реализација Кандинскијеве интуиције о заједничком слоју испод модалитета.",
        art_card_buchenberg_p2:"И ако тачка претходи осјету, избор канала је произвољан. UMAP расипање на страници Геометрија, мелодија, генеративни отисак — то су једнаке пројекције истог објекта. Сјене исте сфере.",
        art_card_buchenberg_p3:"Што затвара круг с Аботом. Квадрат у <em>Flatland</em>-у могао је видјети само једну пројекцију — сјену на својој равнини — и из ње никад није могао реконструисати сферу. Али становник Флетленда коме се дају <em>двије</em> пројекције, сјена <em>и</em> звук, враћа више објекта него што икоји канал носи сам. Сонификација је додатна димензија посматрања која Аботовом Квадрату никад није била додијељена.",
        art_card_buchenberg_p4:"Једна хронолошка напомена: Кандински и Скрјабин претходе <em>Трактатус</em> (1921.). Умјетници су стигли први — опет. Као што је Борхес претходио Витгенштајну, као што је Абот претходио теорији референтних оквира.",
        art_xray_quote:"Ова страница не додаје нове податке. Свака нота коју ћете чути и сваки облик који ћете видјети већ постоји у бази података — као број. Промијенили смо само осјет кроз који гледате. Ако дисонанца гребе ваше ухо на реченици 847, управо сте чули низак <code>finalni_score</code>. Нисте прочитали податак. Осјетили сте га.",
        art_xray_sig:"— X-Ray став, доведен до своје конзеквенце: не само гледати изнутра, већ изабрати орган којим се гледа.",
        art_h_tapestry:"Тапесерија",
        art_tapestry_p1:"Књига као ткано платно. Свака ћелија је једна реченица; редослијед читања иде с лијева на десно, одозго према доље. Боја је <strong>финални скор</strong> побједника — или <strong>побједнички модел</strong>, акпромијените канал. Сиве ћелије још нису исткане. Пређите мишем за реченицу; кликом отвара књигу у Реадеру.",
        art_tapestry_p2:"<strong>Апсолутно</strong> мапира финални скор на фиксну скалу 0,60–1,00 — поштена слика. <strong>Релативно</strong> боји сваку реченицу према њеном <em>перцентилном рангу унутар ове књиге</em>: црвена ћелија није лош пријевод, само један од најслабијих у овом платну.",
        art_tap_all:"Све реченице", art_tap_score:"Скор", art_tap_model:"Модел", art_tap_abs:"Апсолутно", art_tap_rel:"Релативно",
        art_h_sound:"Звук пријевода",
        art_sound_p1:"Исто платно, чуто умјесто виђено. Свака реченица постаје нота у редослиједу читања; њен <strong>финални скор</strong> одређује <strong>висину тона</strong> — што је ткање јаче, то више пјева. Ноте су закључане на пентатонску лљествицу, тако да свака књига свира у складу. Реченица која <strong>још није исткана</strong> је пауза: чујете њену тишину.",
        art_sound_p2:"<strong>Релативно</strong> мапира сваку реченицу на њен перцентилни ранг унутар књиге; <strong>Апсолутно</strong> везује висину тона за сирови скор 0,60–1,00. Ово је трећа сјена исте сфере — уз расипање <em>Геометрије</em> и тканину <em>Тапесерије</em>.",
        art_snd_slow:"споро", art_snd_med:"средње", art_snd_fast:"брзо",
        art_h_fingerprints:"Отисци реченица",
        art_fp_p1:"Свака реченица има облик. њен <strong>вектор уградње</strong> — 1.024 броја који хватају значење — постаје радијални отисак: 64 сектора, сваки држи исјечак вектора; његова дуљина је магнитуда исјечка, његова боја средња вриједност. Вјеран пријевод требао би произвести отисак који <em>личи</em> оригиналу. Не треба референтни пријевод — облик говори сам за себе.",
        art_fp_p2:"Четврта сјена исте сфере — уз расипање <em>Геометрије</em>, ткиво <em>Тапесерије</em> и мелодију <em>Звука пријевода</em>." },
};
